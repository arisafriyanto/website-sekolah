...
<body >
	...
	<div class="container">
		...
		<h4>Edit Gambar</h4><br><br>



	   <form action="" method="post" enctype="multipart/form-data">
	   	<input type="hidden" name="id" value="<?=$data['id']?>">
	   	<input type="hidden" name="gambarlama" value="<?=$data['galeri']?>">
	      ...
	      <div class="file-field input-field">
      		<div class="btn blue">
      		  ...
      		  <input type="file" name="gambar">
      			...
      			<img src="../assets/img/galery/<?php echo $data['galeri'] ?>" width="15%">
      <div class="file-path-wrapper">
	    ...
	    <div class="input-field col s12">
	      <input id="keterangan" name="keterangan" type="text" class="" value="<?php echo $data['keterangan'] ?>">
